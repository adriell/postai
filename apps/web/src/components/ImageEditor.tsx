...
const DEFAULTS: Adjustments = { brightness: 100, contrast: 100, saturation: 100 }
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
        ...
        {/* Preview */}
        <div className="bg-gray-900 flex items-center justify-center" style={{ maxHeight: '40vh', overflow: 'hidden' }}>
          {preview && (
            <img
              ref={imgRef}
              src={preview}
